...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract partial class ScriptableRenderer : IDisposable
    {
        ...
        /// <summary>
        /// Set camera and screen shader variables as described in https://docs.unity.cn/cn/tuanjiemanual/Manual/SL-UnityShaderVariables.html
        /// </summary>
        /// <param name="cmd">CommandBuffer to submit data to GPU.</param>
        /// <param name="cameraData">CameraData containing camera matrices information.</param>
        ...
        void SetPerCameraShaderVariables(CommandBuffer cmd, ref CameraData cameraData, bool isTargetFlipped)
        {
            ...
            // Camera and Screen variables as described in https://docs.unity.cn/cn/tuanjiemanual/Manual/SL-UnityShaderVariables.html
        ...
        /// <summary>
        /// Set shader time variables as described in https://docs.unity.cn/cn/tuanjiemanual/Manual/SL-UnityShaderVariables.html
        /// </summary>
        /// <param name="cmd">CommandBuffer to submit data to GPU.</param>
